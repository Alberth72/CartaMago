...
| Menu Data | MVP menu seed implemented | `src/data/brasasSazonMenu.ts` | Confirmed production prices still missing | Gather final product prices |
...
| Brasas & Sazon Adaptation | Business name, WhatsApp, visible menu categories and processed image gallery added | `src/data/brasasSazonMenu.ts`, `public/client-assets/brasas-sazon/processed/`, `docs/design-asset-workflow.md`, `docs/menu-extraction-brasas-sazon.md` | Prices mostly unclear in photos | Confirm price list before production deploy |
