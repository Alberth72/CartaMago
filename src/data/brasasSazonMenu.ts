...
export const menuItems: MenuItem[] = [
  {
    ...
    description: 'Incluye 4 arepas, 4 papas y maduro.',
    price: 26000,
    badge: 'Especialidad',
    available: true,
  },
  ...
  },
  {
    ...
    categoryId: 'pollos',
    name: '1/4 asado',
    description: 'Cuarto de pollo asado al carbon.',
    price: 26000,
    available: true,
  },
  {
  ...
  },
  {
    ...
    categoryId: 'pollos',
    name: 'Pollo en combo',
    description: 'Pollo asado al carbon o apanado con 4 arepas, 4 papas, maduro y gaseosa litro.',
    price: 26000,
    badge: 'Combo',
    available: true,
  },
  ...
  },
  {
    id: 'bandeja-res',
    categoryId: 'bandejas',
    name: 'Bandeja con res',
    description: 'Con sopa, arroz, frijol, maduro, huevo, ensalada, jugo o limonada.',
    price: 26000,
    available: true,
  },
  {
  ...
  },
  {
    ...
    categoryId: 'bandejas',
    name: 'Bandeja paisa',
    description: 'Con frijol, arroz, huevo, arepa, maduro, ensalada, aguacate, chicharron, morcilla y chorizo.',
    price: 26000,
    badge: 'Completa',
    available: true,
  },
  {
    ...
    categoryId: 'tipicos',
    name: 'Mondongo',
    description: 'Con porcion de arroz, arepa, aguacate y ensalada.',
    price: 26000,
    available: true,
  },
  {
  ...
  },
  {
    ...
    categoryId: 'tipicos',
    name: 'Tilapia',
    description: 'Plato tipico con arroz, frijol, ensalada y acompanamientos.',
    price: 26000,
    available: true,
  },
  {
    ...
    categoryId: 'tipicos',
    name: 'Picada',
    description: 'Res, cerdo, pollo, chicharron, chorizo, arepas, papas y ensalada.',
    price: 26000,
    available: true,
  },
  {
    ...
    categoryId: 'sopas',
    name: 'Sopa de pollo',
    description: 'Sopa o consome con arepa. Grande o pequena.',
    price: 26000,
    available: true,
  },
  {
    ...
    categoryId: 'sopas',
    name: 'Sopa de frijol',
    description: 'Sopa con arepa. Grande o pequena.',
    price: 26000,
    available: true,
  },
  {
    ...
    categoryId: 'infantil',
    name: 'Salchipapas',
    description: 'Menu infantil con papas y salchicha.',
    price: 26000,
    available: true,
  },
  {
    ...
    description: 'Menu infantil con nuggets y papas.',
    price: 26000,
    available: true,
  },
  {
    ...
    categoryId: 'bebidas',
    name: 'Jugo en agua',
    description: 'Sabores: fresa, mora, mango, maracuya y guanabana.',
    price: 26000,
    available: true,
  },
  {
  ...
  },
  {
    ...
    categoryId: 'bebidas',
    name: 'Soda michelada',
    description: 'Bebida refrescante preparada.',
    price: 26000,
    available: true,
  },
  {
    ...
    name: 'Maduro entero',
    description: 'Adicion para acompanar el pedido.',
    price: 26000,
    available: true,
  },
  {
    ...
    description: 'Porcion de papas a la francesa.',
    price: 26000,
    available: true,
  },
  {
  ...
  },
  {
    ...
    categoryId: 'adiciones',
    name: 'Para llevar',
    description: 'Empaque para llevar. En el menu fisico aparece con $500 adicionales.',
    price: 26000,
    available: true,
  },
  {
...
export const menuPhotos: MenuPhoto[] = [
  {
    id: 'cover',
    title: 'Portada',
    image: '/client-assets/brasas-sazon/processed/menu-cover.jpg',
  },
  {
    id: 'pollo',
    title: 'Pollo',
  ...
  {
    id: 'bebidas-adiciones',
    title: 'Bebidas y adiciones',
    image: '/client-assets/brasas-sazon/processed/bebidas-adiciones.jpg',
  },
]
