...
export function CategoryNav({ categories, activeCategory, onSelectCategory }: CategoryNavProps) {
  return (
    <nav className="sticky top-0 z-10 -mx-4 mb-5 flex flex-nowrap gap-2 overflow-x-auto bg-[#fff8ed]/95 px-4 py-2 backdrop-blur sm:mx-0 sm:flex-wrap sm:overflow-visible sm:px-0">
      {categories.map((category) => (
        <button
          ...
          className={`shrink-0 rounded-md border px-4 py-2 text-sm font-black transition sm:shrink ${
