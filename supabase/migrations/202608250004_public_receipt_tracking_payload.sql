-- Extiende el tracking publico por token con metadatos seguros de recibo.
-- No expone telefono, direccion ni payloads privados; solo datos necesarios
-- para imprimir un recibo operativo interno.
